    ...
    <div className="prose max-w-prose mx-auto py-8 px-4">
      ...
      <ol>
        <li>
          ...
          <span className="italic">curious, optimistic, ambitious</span> people.
        </li>
        <li>
      ...
      <Image className="mb-0" alt="DSF usage stats" src={productStats}></Image>
      <span className="text-xs text-gray-500 italic">
        ...
        <table className="min-w-full bg-white border border-gray-300">
          ...
          <tbody>
            <tr className="border-b">
              ...
              <td className="py-3 px-4 text-center align-middle">✅ (small)</td>
            ...
            <tr className="border-b">
              ...
              <td className="py-3 px-4 text-center align-middle">✅ (large)</td>
              <td className="py-3 px-4 text-center align-middle">✅</td>
            </tr>
            <tr>
              <td className="py-3 px-4 text-gray-700 font-medium text-center align-middle">
