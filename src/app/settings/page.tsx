...
import { isInDirectoryAlready, deleteDataFromDirectory } from '../../../lib/utils/process'
        ...
        <div className={styles.container}>
            <Modal closeModal={closeModal} isOpen={isOpen}>
                <div
                    ...
                    <p style={{ color: "grey", marginBottom: '24px' }}>
                        Your listing in the directory will be permanently removed. You will need to create a new listing to be seen.
                    </p>
            ...
            <div className={styles.form}>
                ...
                <div>
                    ...
                    <p className={styles.maxCharacters}>Removing your listing from the directory will be permanent.</p>
                    <div style={{ display: 'flex', alignItems: 'center' }}>
                        <a onClick={buttonStatus ? () => setIsOpen(true) : undefined} className={buttonStatus ? styles.enabled : styles.disabled}>Remove my listing</a>
                    </div>
                </div>
            </div>
        </div>
