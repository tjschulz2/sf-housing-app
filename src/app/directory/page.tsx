    ...
    <div className={styles.container}>
      ...
      <div className={ styles.directoryContainer }>
        <div className={styles.lookingHousematesContainer}>
          ...
          <text className={styles.addInfoText}>Add your information and we will add you to the People looking directory so you can be discovered by communities and organizers</text>
          <Link className={styles.addMeButton} href="/housemates-form">Add me</Link>
        </div>
        <h2>Today</h2>
