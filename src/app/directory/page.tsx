    ...
    <div className={styles.container}>
      ...
      <div className={ styles.directoryContainer }>
        <div className={styles.lookingHousematesContainer}>
          ...
          <p className={styles.addInfoText}>Add your information below and we will add you to the People looking directory so you can be discovered by communities and organizers</p>
